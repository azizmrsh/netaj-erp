...
type Answer = { conversationId: number; answer: string; responseType: string; data?: Record<string, unknown>[]; drillDown?: string; source?: { report: string; from: string; to: string; filters?: string }; export?: { pdf?: string; excel?: string } };
