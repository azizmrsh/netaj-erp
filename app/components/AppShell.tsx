  ...
  return <div className="erp-shell" dir={direction}>
    ...
    <aside className={`erp-sidebar ${collapsed?"is-collapsed":""} ${mobileOpen?"is-mobile-open":""}`}>
      <div className="erp-brand">
        <Link href="/" aria-label="الرئيسية" className="erp-brand-mark"><Image src={theme?.logoUrl||"/media/netaj-company-logo.png"} width={150} height={52} unoptimized alt={session?.companyCode??"NETAj"} className="object-contain"/></Link>
