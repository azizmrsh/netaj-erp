...
export async function GET() {
  try {
    ...
    const [banks, receivables, payables, statements, cash, recentVouchers, categories, parties, accounts, periods, journals, transfers] = await Promise.all([
    ...
    return NextResponse.json({ banks, receivables, payables, statements, cash, recentVouchers,
      expenseCategories: categories[0], revenueCategories: categories[1], costCenters: categories[2], parties, accounts, periods, journals, transfers });
