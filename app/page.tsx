...
const menu = [
  { label: "لوحة الإدارة" },
  { label: "العملاء", href: "/parties" },
  { label: "الموردون", href: "/parties" },
  { label: "المواد والأصناف", href: "/items" },
  { label: "المبيعات", href: "/sales" },
  { label: "المشتريات", href: "/purchases" },
  { label: "المخزون", href: "/inventory" },
  { label: "المصنع", href: "/factory" },
  { label: "السندات", href: "/notes" },
  { label: "النقليات", href: "/transport" },
  { label: "المحاسبة والمالية", href: "/accounting" },
  { label: "الموارد البشرية", href: "/hr" },
  { label: "المبيعات الخارجية", href: "/external" },
  { label: "المصاريف الخارجية", href: "/external" },
