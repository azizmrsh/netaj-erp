...
export async function loadExecutiveDashboard(tx: Tx, range: Range, enabledModules: Set<string>, inactiveDays = 60) {
  const [sales, purchases, ledger, banks, stocks, factory, transport, monthly, customers] = await Promise.all([
