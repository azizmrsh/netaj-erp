...
const supportedCodes = new Set([
  "QT", "PI", "SO", "PR", "PO", "GRN", "DN", "TR", "INV", "PV", "RV", "JE", "BT", "BR", "VAT", "CN", "DBN", "ADJ", "FXR", "BUD", "FT", "FF", "FM", "EMP", "EWR", "PAY", "ADV", "EWC", "XTR", "XCO", "XEX", "PRJ", "PCT", "PCO", "PPC", "SCT", "SCC", "LEAD", "OPP", "ASSET", "MWO", "DMS", "APR", "PRQ", "JOB",
]);
